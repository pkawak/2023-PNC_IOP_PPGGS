...
neat_stress   = np.append(neat_base_df["pnorm"], neat_df["pnorm"])
filled_stress = np.append(filled_base_df["pnorm"], filled_df["pnorm"])

filled_polymer_pi = np.append(filled_base_df["c_pxx_polymer[2]"]/Npolymer + filled_base_df["c_pxx_polymer[3]"]/Npolymer, filled_df["c_pxx_polymer[2]"]/Npolymer + filled_df["c_pxx_polymer[3]"]/Npolymer)
filled_filler_pi  = np.append(filled_base_df["c_pxx_filler[2]"]/Nfiller   + filled_base_df["c_pxx_filler[3]"]/Nfiller  , filled_df["c_pxx_filler[2]"]/Nfiller   + filled_df["c_pxx_filler[3]"]/Nfiller  )

filled_polymer_stress = np.append(filled_base_df["c_pxx_polymer[2]"]/Ntotal + filled_base_df["c_pxx_polymer[3]"]/Ntotal, filled_df["c_pxx_polymer[2]"]/Ntotal + filled_df["c_pxx_polymer[3]"]/Ntotal)
filled_filler_stress  = np.append(filled_base_df["c_pxx_filler[2]"]/Ntotal   + filled_base_df["c_pxx_filler[3]"]/Ntotal  , filled_df["c_pxx_filler[2]"]/Ntotal   + filled_df["c_pxx_filler[3]"]/Ntotal  )
