...
y     = [ get_diff(yi["stress"] - neat_result_df["stress"]).tolist() for yi in filled_result_dfs_reps ]
plot_err(ax, y, filled_marker, filled_color, alpha, r"$\Delta \sigma = \sigma - \sigma_{0}$", name="diff", markerfacecolor=filled_color)
